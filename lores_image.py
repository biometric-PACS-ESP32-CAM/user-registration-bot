...
class ImagesHandler:
    ...
    def process_images(self) -> None:
        ...
        for path_current_img in paths:
            adapt_directory = self._create_new_adapt_directory()
    ...
    def _create_new_adapt_directory(self) -> str:
    ...
    def _compress_image(self, adapt_directory: str, filename: str, img: ImageFile) -> None:
        ...
        adapt_path = adapt_directory + '/' + filename + '.jpg'
        img.save(adapt_path, "JPEG", optimize=True, quality=50)
